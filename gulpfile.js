...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/template-name/css/",
        js: project_folder +"/local/templates/template-name/js/",
        img: project_folder +"/local/templates/template-name/img/",
        image: project_folder +"/local/templates/template-name/image/",
        fonts: project_folder +"/local/templates/template-name/fonts/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/template-name/scss/style.scss",
        js: source_folder +"/local/templates/template-name/js/script.js",
        img: source_folder +"/local/templates/template-name/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/template-name/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/template-name/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/local/templates/template-name/scss/**/*.scss",
        js: source_folder +"/local/templates/template-name/js/**/*.js",
        img: source_folder +"/local/templates/template-name/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/template-name/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/template-name/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/template-name/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/template-name/img/'))
});
